...
from src.navigation_core import MANIFOLD_SIZE, THRESHOLD_SSDIR_NETWORK, DIRECTION_THETAS_SIZE
from src.navigation_core import coordinate_pair_to_radians_cursed_tranform, \
    radians_to_percent, angle_percent_to_thetas_normalized_cached
