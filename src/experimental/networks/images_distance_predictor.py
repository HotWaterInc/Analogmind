...
from src.navigation_core import DISTANCE_THETAS_SIZE, MAX_DISTANCE, ROTATIONS, \
    THRESHOLD_IMAGE_DISTANCE_NETWORK
from src.navigation_core import sample_n_elements, distance_percent_to_distance_thetas
...
def distance_loss(image_distance_predictor_network, storage, sample_rate: int = None):
    ...
    connections: RawConnectionData = storage.connections_authentic_get(
