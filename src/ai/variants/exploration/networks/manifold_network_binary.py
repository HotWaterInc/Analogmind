...
def train_manifold_network_binary_until_thresholds(manifold_network: BaseAutoencoderModel, storage: StorageSuperset2):
...
def train_manifold_network_binary(manifold_network: BaseAutoencoderModel, storage: StorageSuperset2):
    manifold_network = _train_autoencoder_with_distance_constraint(
        manifold_network=manifold_network,
        storage=storage,
        epochs=10001,
